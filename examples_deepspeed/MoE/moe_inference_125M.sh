...
do
    ...
    do
        ...
        do
            ...
            run_cmd="nsys profile --capture-range=cudaProfilerApi --gpu-metrics-device=all deepspeed --num_gpus $NUM_GPUS ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${OUTPUT_BASEPATH}/log/${NAME}_${host}_${current_time}.log"
            echo ${run_cmd}
            eval ${run_cmd}
            set +x
        done
